...
const Notifications: React.FC = () => { 
    ...
    return (
        <div className="fixed bottom-5 right-5 bg-gray-800 bg-opacity-50 shadow-lg rounded-lg p-4 w-80 border border-gray-600 z-50">
            <p className="text-creme font-semibold text-lg text-left">Visitez notre restaurant !</p>
